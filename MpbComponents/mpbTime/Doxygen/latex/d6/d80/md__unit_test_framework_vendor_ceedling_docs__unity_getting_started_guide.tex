\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md269}{}\doxysection{Welcome}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md269}
...
Unity was designed to be cross-\/platform. It works hard to stick with C standards while still providing support for the many embedded C compilers that bend the rules. Unity has been used with many compilers, including GCC, IAR, Clang, Green Hills, Microchip, and MS Visual Studio. It\textquotesingle{}s not much work to get it to work with a new target.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md270}{}\doxysubsection{Overview of the Documents}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md270}
\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md271}{}\doxysubsubsection{Unity Assertions reference}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md271}
This document will guide you through all the assertion options provided by Unity. This is going to be your unit testing bread and butter. You\textquotesingle{}ll spend more time with assertions than any other part of Unity.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md272}{}\doxysubsubsection{Unity Assertions Cheat Sheet}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md272}
This document contains an abridged summary of the assertions described in the previous document. It\textquotesingle{}s perfect for printing and referencing while you familiarize yourself with Unity\textquotesingle{}s options.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md273}{}\doxysubsubsection{Unity Configuration Guide}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md273}
This document is the one to reference when you are going to use Unity with a new target or compiler. It\textquotesingle{}ll guide you through the configuration options and will help you customize your testing experience to meet your needs.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md274}{}\doxysubsubsection{Unity Helper Scripts}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md274}
This document describes the helper scripts that are available for simplifying your testing workflow. It describes the collection of optional Ruby scripts included in the auto directory of your Unity installation. Neither Ruby nor these scripts are necessary for using Unity. They are provided as a convenience for those who wish to use them.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md275}{}\doxysubsubsection{Unity License}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md275}
What\textquotesingle{}s an open source project without a license file? This brief document describes the terms you\textquotesingle{}re agreeing to when you use this software. Basically, we want it to be useful to you in whatever context you want to use it, but please don\textquotesingle{}t blame us if you run into problems.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md276}{}\doxysubsection{Overview of the Folders}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md276}
...
\end{DoxyItemize}\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md277}{}\doxysection{How to Create A Test File}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md277}
Test files are C files. Most often you will create a single test file for each C module that you want to test. The test file should include \mbox{\hyperlink{unity_8h}{unity.\+h}} and the header for your C module to be tested.

Next, a test file will include a {\ttfamily \mbox{\hyperlink{test__mpb_time_base_8c_a63326a1b70b6e3f070e51687798e02de}{set\+Up()}}} and {\ttfamily \mbox{\hyperlink{test__mpb_time_base_8c_ab804e0f66def63262c1d6b4e3d2a2bd7}{tear\+Down()}}} function. The set\+Up function can contain anything you would like to run before each test. The tear\+Down function can contain anything you would like to run after each test. Both functions accept no arguments and return nothing. You may leave either or both of these blank if you have no need for them. If you\textquotesingle{}re using a compiler that is configured to make these functions optional, you may leave them off completely. Not sure? Give it a try. If you compiler complains that it can\textquotesingle{}t find set\+Up or tear\+Down when it links, you\textquotesingle{}ll know you need to at least include an empty function for these.
...
Finally, at the bottom of your test file, you will write a {\ttfamily \mbox{\hyperlink{test__mpb_time_base__runner_8c_a840291bc02cba5474a4cb46a9b9566fe}{main()}}} function. This function will call {\ttfamily \mbox{\hyperlink{unity__internals_8h_aaad15a5d10e50a412d0a6851d0e5091a}{UNITY\+\_\+\+BEGIN()}}}, then {\ttfamily RUN\+\_\+\+TEST} for each test, and finally {\ttfamily \mbox{\hyperlink{unity__internals_8h_aa519129d3af737eb796fc91720fae26a}{UNITY\+\_\+\+END()}}}.This is what will actually trigger each of those test functions to run, so it is important that each function gets its own {\ttfamily RUN\+\_\+\+TEST} call.
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{test__mpb_time_base_8c_a63326a1b70b6e3f070e51687798e02de}{setUp}}(\textcolor{keywordtype}{void}) \{}
\DoxyCodeLine{    \textcolor{comment}{// set stuff up here}}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{test__mpb_time_base_8c_ab804e0f66def63262c1d6b4e3d2a2bd7}{tearDown}}(\textcolor{keywordtype}{void}) \{}
...
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int} \mbox{\hyperlink{test__mpb_time_base__runner_8c_a840291bc02cba5474a4cb46a9b9566fe}{main}}(\textcolor{keywordtype}{void}) \{}
\DoxyCodeLine{    \mbox{\hyperlink{unity__internals_8h_aaad15a5d10e50a412d0a6851d0e5091a}{UNITY\_BEGIN}}();}
\DoxyCodeLine{    \mbox{\hyperlink{test__mpb_time_base__runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_function\_should\_doBlahAndBlah);}
\DoxyCodeLine{    \mbox{\hyperlink{test__mpb_time_base__runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_function\_should\_doAlsoDoBlah);}
...
It\textquotesingle{}s possible that you will need more customization than this, eventually. For that sort of thing, you\textquotesingle{}re going to want to look at the configuration guide. This should be enough to get you going, though.\hypertarget{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md278}{}\doxysection{How to Build and Run A Test File}\label{md__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md278}
